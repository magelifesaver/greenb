...
<div id="barcodes-wrapper-tooltip" style="float: initial;">
    ...
    <button type="button" name="barcodes_import_orders" id="barcodes-import-orders-items" class="button" data-action-type="items" data-order-id="<?php echo esc_js($orderId); ?>">
