	...
	public static function render(array $ctx) : void {
		...
		<div class="aaa-oc-my-order-totals"
			...
			<div class="aaa-oc-tip-section" style="margin-top:0.75rem; border:1px solid #ccc;border-radius:4px;padding:10px;background:#f9f9f9;">
				...
				<div style="display:flex; justify-content:space-between;">
					<span>Assigned Driver:</span><span><?php echo $driver ? esc_html($driver->display_name) : 'N/A'; ?></span>
				</div>
				<?php if ($checkout_tip > 0 || $epay_tip > 0): ?>
				<div style="margin-top:0.5rem; font-size:12px; opacity:0.85;">
					<?php if ($checkout_tip > 0): ?><div>Checkout Tip → <?php echo $driver ? esc_html($driver->display_name) : 'N/A'; ?></div><?php endif; ?>
					<?php if ($epay_tip > 0): ?><div>eTip<?php echo $real_method ? ' ('.esc_html($real_method).')' : ''; ?> → <?php echo $driver ? esc_html($driver->display_name) : 'N/A'; ?></div><?php endif; ?>
				</div>
				<?php endif; ?>
			</div>
