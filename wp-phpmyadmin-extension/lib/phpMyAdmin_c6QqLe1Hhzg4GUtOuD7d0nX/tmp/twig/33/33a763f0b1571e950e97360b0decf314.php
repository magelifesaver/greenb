...
class __TwigTemplate_66a814ea23ab77dd4113eb094c430199 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/chroot/home/a2ea4401/73e3dceaec.nxcli.io/html/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_c6QqLe1Hhzg4GUtOuD7d0nX/templates/preferences/header.twig");
    }
}
