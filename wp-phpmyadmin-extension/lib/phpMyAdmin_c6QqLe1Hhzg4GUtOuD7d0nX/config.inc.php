...
$cfg['blowfish_secret']					= 'gLmK^4BTTt\"K=hW1y}aEk9};UVO]sKH*' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_c6QqLe1Hhzg4GUtOuD7d0nX/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://lokeydelivery.com/wp-admin/?rand=82993036&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://lokeydelivery.com/wp-admin/?rand=89813502&pma_logout=1';
