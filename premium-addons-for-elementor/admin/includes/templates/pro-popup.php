	...
	<div class="pa-popup-outer-body">
		<div class="popup-body">
			...
			<div class="pa-popup-cta-wrapper">
				...
				<a class="pa-popup-cta" target="_blank" aria-label="<?php echo esc_attr_e( 'upgrade now', 'premium-addons-for-elementor' ); ?>"><?php echo esc_html_e( 'GET PRO (35% OFF)', 'premium-addons-for-elementor' ); ?></a>
			</div>
		</div>
	</div>
</div>
