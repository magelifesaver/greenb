...
== Changelog ==
* 2.41.1 Fixed "Download IPv4 database only" checkbox was ignore during database update.
* 2.41.0 Added Perplexity bot in crawler list.
* 2.40.0 Added ability to flush cached data.
* 2.39.5 Fixed issue saving backend error page.
* 2.39.4 Removed internal table updates.
* 2.39.3 Fixed statistics log stopped.
* 2.39.2 Minor bugs fix.
* 2.39.1 Required PHP 7.4 and above. Fixed default fields value.
* 2.39.0 Improved JavaScript and backend codes.
* 2.38.14 Security fixes.
* 2.38.13 Updated crawler list. Minor security updates.
* 2.38.12 Tested up to WordPress 6.8.
