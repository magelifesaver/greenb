    ...
    public function getGlobalFields()
    {
        return [
            ...
            'fields' => [
                ...
                [
                    'type' => 'html',
                    'html' => __('<p><a target="_blank" rel="noopener" href="https://wpmanageninja.com/docs/fluent-form/payment-settings/">Please read the documentation</a> to learn how to setup <b>Authorize.Net Payment</b> Gateway.</p>',
                        'fluentformpro')
                ]
            ]
        ];
