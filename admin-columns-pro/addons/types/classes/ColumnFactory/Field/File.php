...
class File extends FieldFactory
{
    ...
    protected function get_editing(Config $config): ?ACP\Editing\Service
    {
        ...
        return new ACP\Editing\Service\Basic(
            (new ACP\Editing\View\Media())->set_clear_button(true)->set_multiple($this->field->is_repeatable()),
            $storage
        );
    }
    ...
    protected function get_search(Config $config): ?ACP\Search\Comparison
    {
        return new ACP\Search\Comparison\Meta\SearchableText(
            ...
            (new ACA\Types\ContextQueryMetaFactory())->create_by_context($this->context, $this->field)
        );
    }
