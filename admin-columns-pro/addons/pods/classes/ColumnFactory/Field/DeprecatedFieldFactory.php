...
final class DeprecatedFieldFactory extends ColumnFactory
{
    ...
    {
        $url = Documentation::ARTICLE_UPGRADE_V3_TO_V4;
        ...
        return sprintf(
            ...
            sprintf(
                ...
                sprintf('<a href="%s">%s</a>', $url, __('our documentation', 'codepress-admin-column'))
            ),
    ...
    protected function get_formatters(Config $config): FormatterCollection
    {
        return parent::get_formatters($config)->add(
            new \AC\Value\Formatter\Message('Column not supported since version 7.0')
        );
    }
