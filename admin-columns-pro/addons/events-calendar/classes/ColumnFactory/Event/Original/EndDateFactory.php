...
class EndDateFactory extends DefaultColumnFactory
{

    private const META_KEY = '_EventEndDate';
    ...
    {
        return parent::get_feature_settings_builder($config)->set_search(null, $this->filter_date_format);
    }
