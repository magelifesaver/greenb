...
class OrderSubscriptionFactory extends DefaultAdvancedColumnFactory
{
    ...
    protected function get_default_factories(TableScreen $table_screen): array
    {
        ...
        return [
            ...
            'orders'            => OrderSubscription\Original\Orders::class,
            'order_title'       => OrderSubscription\Original\OrderItems::class,
