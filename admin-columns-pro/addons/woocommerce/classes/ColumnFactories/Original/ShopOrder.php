    ...
    implements ColumnFactoryCollectionFactory
{
    ...
    public function __construct(Container $container, DefaultColumnsRepository $default_columns_repository)
    {
    ...
    public function create(TableScreen $table_screen): ColumnFactories
    {
        ...
        foreach ($this->default_columns_repository->find_all_cached($table_screen->get_id()) as $type => $label) {
