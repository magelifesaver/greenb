...
class Subscriptions implements Formatter
{

    private ExtendedValue\User\Subscriptions $extended_value;

    public function __construct(ExtendedValue\User\Subscriptions $extended_value)
    {
    ...
    public function format(Value $value)
    {
        ...
        $link = $this->extended_value->get_link($user_id, (string)$label)
                                     ...
                                     ->with_title(
                                         sprintf(
                                             __('Recent subscriptions by %s', 'codepress-admin-columns'),
