...
class CompletedDateFactory extends ACP\Column\AdvancedColumnFactory
{
    ...
    {
        return __('Date Completed', 'codepress-admin-columns');
    }

    public function get_column_type(): string
    {
        return 'column-order_date_completed';
    }

    protected function get_formatters(Config $config): FormatterCollection
    {
        $formatters = new FormatterCollection([
            new Formatter\Order\Date\CompletedDate(),
            new Timestamp(),
        ]);
