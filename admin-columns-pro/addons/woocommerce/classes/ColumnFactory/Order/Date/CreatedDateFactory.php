...
class CreatedDateFactory extends ACP\Column\AdvancedColumnFactory
{
    ...
    {
        return __('Date Created', 'codepress-admin-columns');
    }

    public function get_column_type(): string
    {
        return 'column-order_date_created';
    }

    protected function get_formatters(Config $config): FormatterCollection
    {
        $formatters = new FormatterCollection([
            new Formatter\Order\Date\CreatedDate(),
            new Timestamp(),
        ]);
