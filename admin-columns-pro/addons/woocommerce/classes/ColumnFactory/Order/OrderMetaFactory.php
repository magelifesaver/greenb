...
use AC\Value\Formatter\Date\DateFormat;
...
class OrderMetaFactory extends ACP\Column\AdvancedColumnFactory
{
    ...
    private function get_base_formatter($config): Setting\Formatter
    {
    ...
    protected function get_export(Config $config): ?ACP\Export\Service
    {
        ...
        switch ($field_type) {
            ...
            case FieldType::TYPE_MEDIA :
                return new Export\Order\Meta\Image($meta_key);
            case FieldType::TYPE_DATE :
                return new Export\Order\Meta\Date($meta_key);
            default:
