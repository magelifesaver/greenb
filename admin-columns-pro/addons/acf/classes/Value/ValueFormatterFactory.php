    ...
    public function get_field_formatters(
        ...
        switch ($field->get_type()) {
            case FieldType::TYPE_COLOR_PICKER:
                return $formatters->add(new AC\Value\Formatter\Color());

            case FieldType::TYPE_BOOLEAN:
                return $formatters->add(new AC\Value\Formatter\YesNoIcon());
            ...
            case FieldType::TYPE_DATE_TIME_PICKER:
                return $formatters->prepend(new AC\Value\Formatter\Timestamp());
            ...
            case FieldType::TYPE_WYSIWYG:
                return $formatters->add(new AC\Value\Formatter\StripTags());
            default:
                return $formatters;
        }
    }
