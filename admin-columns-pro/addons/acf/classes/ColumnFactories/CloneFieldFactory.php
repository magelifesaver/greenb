...
class CloneFieldFactory
{
    ...
    public function create(AC\Type\TableScreenContext $table_context, ACF\Field $field): ?AC\Column\ColumnFactory
    {
        if ( ! $field->is_clone()) {
            return null;
        }
    ...
    private function create_prefixed_clone(array $settings): ?ACF\Field
    {
