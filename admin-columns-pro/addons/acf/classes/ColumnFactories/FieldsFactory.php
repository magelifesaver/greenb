...
class FieldsFactory implements AC\ColumnFactoryCollectionFactory
{
     ...
     * @return ACF\Field[]
     */
    protected function get_fields(TableScreen $table_screen): array
    {
        return $this->field_repository->find_by_table_screen($table_screen);
    }
    ...
    public function create(TableScreen $table_screen): ColumnFactories
    {
        ...
        foreach ($this->get_fields($table_screen) as $field) {
            switch (true) {
                case $field->is_clone():
