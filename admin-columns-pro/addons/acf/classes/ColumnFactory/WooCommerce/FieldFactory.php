...
use ACA\ACF\Editing;
use ACA\ACF\Export\ServiceFactory;
use ACA\ACF\Field;
use ACA\ACF\Search;
...
class FieldFactory extends ColumnFactory\AcfFactory
{
    ...
    private function get_substitute_context(): TableScreenContext
    {
    ...
    protected function get_editing(Config $config): ?ACP\Editing\Service
    {
        return $this->editing_factory->create(
            $this->field,
            (new Editing\StorageFactory())->create($this->field, $this->get_substitute_context())
        );
    }
