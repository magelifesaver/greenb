...
class GroupFieldFactory extends AdvancedColumnFieldFactory
{
    ...
    private Export\ServiceFactory $export_service_factory;
    ...
    public function __construct(
        ...
        Export\ServiceFactory $export_service_factory,
