...
class FieldFormattableFactory
{
    ...
    public function create(Field $field, Setting\Formatter $base_formatter): ?FormattableConfig
    {
        $unsupported = [
        ...
        switch ($field->get_type()) {
            ...
            case FieldType::TYPE_DATE_TIME_PICKER:
                return new FormattableConfig(
                    new DateFormatter\DateValueFormatter(new Setting\FormatterCollection([
                        $base_formatter,
                        new Value\Formatter\Date\DateMapper('Y-m-d H:i:s', 'Y-m-d'),
                    ]))
                );
            ...
            case FieldType::TYPE_DATE_PICKER:
                return new FormattableConfig(
                    new DateFormatter\DateValueFormatter(new Setting\FormatterCollection([
                        $base_formatter,
                        new Value\Formatter\Date\DateMapper('Ymd', 'Y-m-d'),
                    ]))
                );
