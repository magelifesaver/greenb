...
final class RankMathDescription extends ACP\Column\AdvancedColumnFactory
{

    use ConditionalFormatTrait;
    use GroupTrait;

    private const META_KEY = 'rank_math_description';

    public function get_column_type(): string
    {
        return 'column-rankmath_description';
    }

    public function get_label(): string
    {
        return __('RankMath Description', 'codepress-admin-columns');
    }
