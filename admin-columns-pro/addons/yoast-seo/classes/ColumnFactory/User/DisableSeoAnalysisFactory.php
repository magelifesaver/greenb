...
class DisableSeoAnalysisFactory extends AdvancedColumnFactory
{

    private const META_KEY = 'wpseo_keyword_analysis_disable';
    ...
    {
        return 'column-yoast_disable_seo_analysis';
    }

    public function get_label(): string
    {
        return __('Disable SEO analysis', 'wordpress-seo');
    }

    protected function get_formatters(Config $config): FormatterCollection
    {
        return parent::get_formatters($config)
                     ->add(new AC\Value\Formatter\User\Meta(self::META_KEY))
                     ->add(new AC\Value\Formatter\YesNoIcon());
    }
