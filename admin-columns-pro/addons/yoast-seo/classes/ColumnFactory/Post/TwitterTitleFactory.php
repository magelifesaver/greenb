...
class TwitterTitleFactory extends ACP\Column\AdvancedColumnFactory
{

    private const META_KEY = '_yoast_wpseo_twitter-title';
    ...
    {
        return 'column-yoast_twitter_title';
    }

    public function get_label(): string
    {
        return __('Twitter Title', 'codepress-admin-columns');
    }

    protected function get_formatters(Config $config): FormatterCollection
    {
        return parent::get_formatters($config)->add(new AC\Value\Formatter\Post\Meta(self::META_KEY));
    }
