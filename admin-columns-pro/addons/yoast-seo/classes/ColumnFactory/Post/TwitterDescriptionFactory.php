...
class TwitterDescriptionFactory extends ACP\Column\AdvancedColumnFactory
{

    private const META_KEY = '_yoast_wpseo_twitter-description';
    ...
    {
        return 'column-yoast_twitter_description';
    }

    public function get_label(): string
    {
        return __('Twitter Description', 'codepress-admin-columns');
    }

    protected function get_formatters(Config $config): FormatterCollection
    {
        return parent::get_formatters($config)->add(
            new AC\Value\Formatter\Post\Meta('_yoast_wpseo_twitter-description')
        );
    }
