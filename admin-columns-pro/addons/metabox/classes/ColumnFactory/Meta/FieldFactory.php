...
class FieldFactory extends ACP\Column\AdvancedColumnFactory
{
    ...
    private Export\ModelFactory $export_factory;
    ...
    public function __construct(
        ...
        Export\ModelFactory $export_factory,
    ...
    protected function get_base_formatters(): FormatterCollection
    {
        return new FormatterCollection([
            new Value\Formatter\MetaboxValue($this->table_context->get_meta_type(), $this->field->get_id()),
        ]);
    }
