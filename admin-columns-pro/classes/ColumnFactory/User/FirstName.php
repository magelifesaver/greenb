...
use AC\ColumnFactory\User\FirstNameFactory;
...
class FirstName extends EnhancedColumnFactory
{

    private const META_KEY = 'first_name';

    use ACP\ConditionalFormat\ConditionalFormatTrait;

    public function __construct(
        FirstNameFactory $column_factory,
    ...
    {
        return new Export\Model\User\Meta(self::META_KEY);
    }
