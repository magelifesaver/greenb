...
class BAPFSidebarButton extends Component {

  static slug = 'et_pb_br_sidebar_button';
  ...
  componentDidUpdate(oldProps) {
      var update = false;
      BAPFSidebarButton.parameters.forEach(key => {
  ...
  componentDidMount() {
    ...
    body.append('action', 'brapf_sidebar_button');
...
export default BAPFSidebarButton;
