<?php
/**
 * Banner image and link field for Promo products without relying on external
 * meta box plugins.  This module registers a meta box with a simple
 * interface to upload or select an image from the WordPress media library and
 * optionally add a link.  The field appears only when editing or creating
 * a Promo product type.
 */
...
/**
 * Save the banner image and link meta when a product is saved.  Only save for
 * promo products and when a valid nonce is present.
 *
