<input type="text" placeholder="" value="<?php echo (!is_array($field_value)) ? esc_attr($field_value) : esc_attr($field_value['value']); ?>" name="<?php echo esc_attr($html_name); ?>[value]" class="text widefat rad4" style="width: 75%;" />
