<?php
/**
 * View for the Purchase Orders' Email (Default template)
 *
 * @since 0.9.11
 *
 * @var string $body
												...
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td style="padding-right: 0px;padding-left: 0px;" align="center">
															...
															<?php if ( $logo ) : ?>
																<img align="center" border="0" src="<?php echo esc_url( $logo ) ?>" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 204px;" width="204"/>
															<?php else : ?>
										...
										<tr>
											<td style="overflow-wrap:break-word;word-break:break-word;padding:10px 15px;font-family:arial,helvetica,sans-serif;" align="left">
												...
												<div style="line-height: 140%; text-align: left; word-wrap: break-word;">
													<div style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><?php echo wp_kses_post( html_entity_decode( $body, ENT_COMPAT, 'UTF-8' ) ); ?></span></div>
