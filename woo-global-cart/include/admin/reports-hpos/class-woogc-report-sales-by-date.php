 ...
 * @version     2.1.0
 */
class WooGC_Report_Sales_By_Date extends WooGC_Admin_Report {
	...
	private function query_report_data() {
			...
			array(
				'data'         => array(
					...
					'shipping_tax_amount' => array(
						'type'     => 'wc_order_operational_data',
						'function' => 'SUM',
        ...
        if ( $WooGC->functions->is_HPOS_active() )
            {
                $this->report_data->full_refunds    =   array(); 
                $this->report_data->partial_refunds =   array();
                $this->report_data->refund_lines    =   array();  
            }
            else
            {
	...
	public function output_report() {
		...
		include_once(WOOGC_PATH . '/include/admin/views/html-report-by-date.php');
	}
	...
	public function get_main_chart() {
		...
		$data = array(
			'order_counts'         => $this->prepare_chart_data( $this->report_data->order_counts, 'date_created_gmt', 'count', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'order_item_counts'    => $this->prepare_chart_data( $this->report_data->order_items, 'date_created_gmt', 'order_item_count', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'order_amounts'        => $this->prepare_chart_data( $this->report_data->orders, 'date_created_gmt', 'total_sales', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'coupon_amounts'       => $this->prepare_chart_data( $this->report_data->coupons, 'date_created_gmt', 'discount_amount', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'shipping_amounts'     => $this->prepare_chart_data( $this->report_data->orders, 'date_created_gmt', 'total_shipping', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'refund_amounts'       => $this->prepare_chart_data( $this->report_data->refund_lines, 'date_created_gmt', 'total_refund', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'shipping_tax_amounts' => $this->prepare_chart_data( $this->report_data->orders, 'date_created_gmt', 'total_shipping_tax', $this->chart_interval, $this->start_date, $this->chart_groupby ),
			'tax_amounts'          => $this->prepare_chart_data( $this->report_data->orders, 'date_created_gmt', 'total_tax', $this->chart_interval, $this->start_date, $this->chart_groupby ),
