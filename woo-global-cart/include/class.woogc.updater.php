             ...
             public function __construct( $api_url, $slug, $plugin )
                {
                    ...
                    $this->licence     =   WooGC_licence::get_licence_data();
                }
             ...
             public function check_for_plugin_update ( $checked_data )
                {
                     ...
                     $busy  =   get_site_transient ( 'woogc-check_for_plugin_update__server_busy' );
                     if ( ! empty ( $busy ) )
                        return $checked_data;
                             ...
                             if(is_wp_error( $data ) || $data['response']['code'] != 200)
                                {
                                    ...
                                    set_site_transient( 'woogc-check_for_plugin_update__server_busy' , '1', ( 60 * 60 * 4 ) +  rand ( 100, 36000 ) );
                                    
                                    return $checked_data;
                                }
                                
                             set_site_transient( 'woogc-check_for_plugin_update_' . md5( $request_uri ), $data, ( 60 * 60 * 48 ) +  rand ( 100, 36000 ) );
