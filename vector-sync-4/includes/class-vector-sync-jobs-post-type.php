...
class Vector_Sync_Jobs_Post_Type {
    ...
    public static function init() {
        // Register the post type immediately.  We avoid hooking into the
        // init action here because this method itself is invoked during the
        // init hook via vector_sync_jobs_init().  Registering directly
        // ensures the post type is available on the first page load.
