...
class FCA11Y_Cart_Accessibility {
    ...
    public static function enqueue_assets() {
        ...
        // Check for both the WPXtension Fast Cart class and Barn2's namespaced class. Do not
        // prefix the Barn2 class with a leading backslash when checking for existence. PHP
        // resolves class names relative to the global namespace by default, and omitting
        // the leading slash avoids false negatives in some contexts.
