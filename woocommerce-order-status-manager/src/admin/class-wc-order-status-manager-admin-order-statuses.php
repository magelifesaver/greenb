...
class WC_Order_Status_Manager_Admin_Order_Statuses {
	...
	public function order_status_data_meta_box() {
		...
		<div id="order_status_options" class="panel woocommerce_options_panel">
			...
			<div class="options_group">
				...
				if (in_array($status->get_slug(), wc_order_status_manager()->get_order_statuses_instance()->getCoreOrderStatusesThatRequirePayment(), true)) {
	...
	protected function nextStatusesOptions(WC_Order_Status_Manager_Order_Status $status) : array
	{
		$options = [];
