...
+function ($) {
  ...
  var Dropdown = function (element) {
    $(element).on('click.bs.arodropdown', this.toggle)
  }
  ...
  Dropdown.prototype.toggle = function (e) {
    ...
    if (!isActive) {
      ...
      $parent
        .toggleClass('open')
        .trigger($.Event('shown.bs.arodropdown', relatedTarget))
    }
  ...
  $.fn.arodropdown.noConflict = function () {
    $.fn.arodropdown = old
    return this
  }
  ...
  $(document)
    .on('click.bs.arodropdown.data-api', clearMenus)
    .on('click.bs.arodropdown.data-api', '.dropdown form', function (e) { e.stopPropagation() })
    .on('click.bs.arodropdown.data-api', toggle, Dropdown.prototype.toggle)
    .on('keydown.bs.arodropdown.data-api', toggle, Dropdown.prototype.keydown)
    .on('keydown.bs.arodropdown.data-api', '.dropdown-menu', Dropdown.prototype.keydown)
