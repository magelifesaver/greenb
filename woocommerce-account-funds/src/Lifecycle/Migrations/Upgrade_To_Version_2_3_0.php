 ...
 * @since 3.2.0
 */
final class Upgrade_To_Version_2_3_0 implements Migration {

	/**
	 * We are updating the plugin from an older version than 2.3.0, so don't need to execute the migration script of version 2.3.7.
	 *
	 * @since 3.2.0
	 *
	 * @return void
