 ...
 */
namespace Kestrel\Account_Funds\Scoped\Carbon\Traits;

use Kestrel\Account_Funds\Scoped\Carbon\CarbonInterface;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidTypeException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\NotLocaleAwareException;
use Kestrel\Account_Funds\Scoped\Carbon\Language;
use Kestrel\Account_Funds\Scoped\Carbon\Translator;
use Kestrel\Account_Funds\Scoped\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorBagInterface;
use Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface;
use Kestrel\Account_Funds\Scoped\Symfony\Contracts\Translation\LocaleAwareInterface;
use Kestrel\Account_Funds\Scoped\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('Kestrel\Account_Funds\Scoped\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('Kestrel\Account_Funds\Scoped\Symfony\Contracts\Translation\TranslatorInterface', 'Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface');
}
...
trait Localization
{
     ...
     * Default translator.
     *
     * @var \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @return \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     * @param \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
