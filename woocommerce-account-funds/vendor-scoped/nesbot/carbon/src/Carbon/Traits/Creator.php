...
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidDateException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidFormatException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \Kestrel\Account_Funds\Scoped\Carbon\CarbonImmutable|\Carbon\Carbon|null $mock */
     ...
     * @param \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
