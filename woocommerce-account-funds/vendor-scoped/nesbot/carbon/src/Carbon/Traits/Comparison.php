...
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\BadComparisonUnitException;
...
trait Comparison
{
     ...
     * ```
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|mixed $date
     *
     * @see equalTo()
     *
     * @return bool
     ...
     * ```
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|mixed $date1
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|mixed $date2
     ...
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|string|null $date   instance to compare with or null to use current day.
     *
     * @return bool
     */
     ...
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|null $date instance to compare with or null to use current day.
     *
     ...
     * ```
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|string|null $date       The instance to compare with or null to use current day.
     ...
     * ```
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|null $date       The instance to compare with or null to use the current date.
     * @param bool                                   $ofSameYear Check if it is the same month in the same year.
     *
     * @return bool
     */
     ...
     * ```
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\DateTimeInterface|null $date The instance to compare with or null to use current day.
     *
     * @return bool
     */
