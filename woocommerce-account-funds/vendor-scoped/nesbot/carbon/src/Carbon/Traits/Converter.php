...
use Kestrel\Account_Funds\Scoped\Carbon\CarbonPeriodImmutable;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    public function __toString()
    {
        ...
        return $format instanceof Closure ? $format($this) : $this->rawFormat($format ?: (\defined('Kestrel\Account_Funds\Scoped\static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : CarbonInterface::DEFAULT_TO_STRING_FORMAT));
    }
    /**
    ...
    {
        return $this->avoidMutation()->setTimezone('GMT')->rawFormat(\defined('Kestrel\Account_Funds\Scoped\static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : CarbonInterface::RFC7231_FORMAT);
    }
    /**
