...
use Kestrel\Account_Funds\Scoped\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
     ...
     *
     * @return \Kestrel\Account_Funds\Scoped\Carbon\CarbonImmutable|\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \Kestrel\Account_Funds\Scoped\Carbon\CarbonImmutable|\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \Kestrel\Account_Funds\Scoped\Carbon\CarbonImmutable|\Carbon\Carbon $testInstance */
