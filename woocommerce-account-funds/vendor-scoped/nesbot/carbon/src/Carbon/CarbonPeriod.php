...
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\EndLessPeriodException;
...
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidPeriodDateException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidPeriodParameterException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\NotACarbonClassException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\NotAPeriodException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnknownGetterException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnknownMethodException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\Carbon\CarbonPeriod|\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \Kestrel\Account_Funds\Scoped\Carbon\Carbon|\Carbon\CarbonPeriod|\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \Kestrel\Account_Funds\Scoped\Carbon\CarbonInterface
     */
