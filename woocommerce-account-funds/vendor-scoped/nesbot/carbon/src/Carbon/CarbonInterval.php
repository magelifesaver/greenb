...
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\BadFluentConstructorException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\BadFluentSetterException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidCastException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\InvalidIntervalException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\OutOfRangeException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\ParseErrorException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnitNotConfiguredException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnknownGetterException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnknownSetterException;
use Kestrel\Account_Funds\Scoped\Carbon\Exceptions\UnknownUnitException;
use Kestrel\Account_Funds\Scoped\Carbon\Traits\IntervalRounding;
use Kestrel\Account_Funds\Scoped\Carbon\Traits\IntervalStep;
use Kestrel\Account_Funds\Scoped\Carbon\Traits\MagicParameter;
use Kestrel\Account_Funds\Scoped\Carbon\Traits\Mixin;
use Kestrel\Account_Funds\Scoped\Carbon\Traits\Options;
use Kestrel\Account_Funds\Scoped\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \Kestrel\Account_Funds\Scoped\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = \false, $parts = -1, $options = null)
    {
        ...
        $declensionMode = null;
        /** @var \Kestrel\Account_Funds\Scoped\Symfony\Component\Translation\Translator $translator */
