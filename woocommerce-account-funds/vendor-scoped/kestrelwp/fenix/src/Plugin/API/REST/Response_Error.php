...
final class Response_Error
{
    ...
    /** @var string default value for the error code */
    protected static string $default = self::SERVER_ERROR;
    /**
    ...
    {
        return self::get_status_code($this->value());
    }
    /**
    ...
    {
        return self::get_status_message($this->value());
    }
    /**
