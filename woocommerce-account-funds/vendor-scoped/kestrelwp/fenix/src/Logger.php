...
use Error;
use Kestrel\Account_Funds\Scoped\Kestrel\Fenix\Logger\Basic_Logger;
 ...
 * Logger.
 *
 * Loosely based on the PSR-3 logger and the WooCommerce logger interface.
 * We can't extend the former as it would be scoped to the plugin namespace, nor the latter as we can't assume WooCommerce.
 *
 * @link https://www.php-fig.org/psr/psr-3/
 *
 * @TODO in version 2.0.0 we should swap the last two parameter positions to align more closely with the PSR-3 interface
 *
 * @since 1.0.0
 *
