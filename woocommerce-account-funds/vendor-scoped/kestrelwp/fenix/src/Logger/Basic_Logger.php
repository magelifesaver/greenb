...
namespace Kestrel\Account_Funds\Scoped\Kestrel\Fenix\Logger;

defined('ABSPATH') or exit;
use Kestrel\Account_Funds\Scoped\Kestrel\Fenix\Logger as Main_Logger;
use Kestrel\Account_Funds\Scoped\Kestrel\Fenix\Logger\Contracts\Logger;
use WC_Logger;
/**
 * Basic logger.
 *
