...
final class WordPress
{
    ...
    /**
     * Returns the URL where the WordPress installation is for the current site.
     *
     * @since 1.7.1
     *
    ...
    /**
     * Determines if the WordPress installation is in staging mode.
     *
     * @NOTE This method is not 100% foolproof method to detect staging environments.
     *
     * @since 1.6.0
     *
     * @return bool
    ...
    /**
     * Determines if the WordPress installation is in live mode.
     *
     * This is the opposite of `is_staging()`.
     *
     * @since 1.6.0
     *
     * @return bool
