...
use Kestrel\Account_Funds\Scoped\Kestrel\Fenix\Plugin\Lifecycle\Contracts\Uninstaller;
...
abstract class Loader
{
    ...
    /** @var class-string<WooCommerce_Extension|WordPress_Plugin> plugin implementation should override this to point to the concrete plugin class */
    ...
    public function load_plugin()
    {
        ...
        $template_functions = dirname($plugin_file) . '/functions.php';
        // load any optional template functions in the global namespace
        if (is_readable($template_functions)) {
            require_once $template_functions;
            // phpcs:ignore
        }
        $class = static::PLUGIN_MAIN_CLASS;
        $instance = $class::instance(['file' => $plugin_file]);
