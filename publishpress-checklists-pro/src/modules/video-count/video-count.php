...
use PublishPress\ChecklistsPro\VideoCount\Requirement\VideoCount;
...
/**
 * Class PPCH_Video_Count
 *
 * @todo Refactor this module and all the modules system to use DI.
 */
#[\AllowDynamicProperties]
class PPCH_Video_Count extends Module
{
    const SETTINGS_SLUG = 'pp-video-count-prosettings';

    const POST_META_PREFIX = 'pp_video_count_custom_item_';

    public $module_name = 'video_count';
    ...
    public function __construct()
    {
        ...
        $args = [
            ...
            'short_description'    => esc_html__(
                'Define tasks that verify total video in content',
                'publishpress-checklists-pro'
            ),
    ...
    {
        $scriptHandle = 'pp-video-count-admin';

        wp_enqueue_script(
            $scriptHandle,
            plugins_url('/src/modules/video-count/assets/js/meta-box.js', $this->pluginFile),
