...
use PublishPress\ChecklistsPro\NoHeadingTags\Requirement\NoHeadingTags;
...
/**
 * Class PPCH_No_Heading_Tags
 *
 * @todo Refactor this module and all the modules system to use DI.
 */
#[\AllowDynamicProperties]
class PPCH_No_Heading_Tags extends Module
{
    const SETTINGS_SLUG = 'pp-no-heading-tags-prosettings';

    const POST_META_PREFIX = 'pp_no_heading_tags_custom_item_';

    public $module_name = 'no_heading_tags';
    ...
    /**
     * Construct the PPCH_No_Heading_Tags class
     *
    ...
    public function __construct()
    {
        ...
        $args = [
            'title'                => esc_html__(
                'No Heading Tags in Content',
                'publishpress-checklists-pro'
            ),
            'short_description'    => esc_html__(
                'Define tasks that verify no prohibited heading tags are in content',
                'publishpress-checklists-pro'
            ),
            ...
            'icon_class'           => 'dashicons dashicons-editor-textcolor',
            'slug'                 => 'no-heading-tags',
            'default_options'      => [
                'enabled' => 'on',
            ],
            'options_page'         => false,
    ...
    {
        $scriptHandle = 'pp-no-heading-tags-admin';

        wp_enqueue_script(
            $scriptHandle,
            plugins_url('/src/modules/no-heading-tags/assets/js/meta-box.js', $this->pluginFile),
    ...
    {
        $requirements[] = NoHeadingTags::class;
