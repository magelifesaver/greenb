...
use PublishPress\ChecklistsPro\ImageCount\Requirement\ImageCount;
...
/**
 * Class PPCH_Image_Count
 *
 * @todo Refactor this module and all the modules system to use DI.
 */
#[\AllowDynamicProperties]
class PPCH_Image_Count extends Module
{
    const SETTINGS_SLUG = 'pp-image-count-prosettings';

    const POST_META_PREFIX = 'pp_image_count_custom_item_';

    public $module_name = 'image_count';
    ...
    public function __construct()
    {
        ...
        $args = [
            ...
            'short_description'    => esc_html__(
                'Define tasks that verify total images in content',
                'publishpress-checklists-pro'
            ),
    ...
    {
        $scriptHandle = 'pp-image-count-admin';

        wp_enqueue_script(
            $scriptHandle,
            plugins_url('/src/modules/image-count/assets/js/meta-box.js', $this->pluginFile),
