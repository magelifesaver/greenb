...
class Downloadable extends Base
{
    /**
    ...
    {
        $this->lang['label']          = esc_html__('Check the "Downloadable" box', 'publishpress-checklists-pro');
        $this->lang['label_settings'] = esc_html__('Check the "Downloadable" box', 'publishpress-checklists-pro');
    }
