...
class ManageStock extends Base
{
    /**
    ...
    {
        $this->lang['label_settings'] = esc_html__('Check the "Manage stock?" box', 'publishpress-checklists-pro');
        $this->lang['label']          = esc_html__('Check the "Manage stock?" box', 'publishpress-checklists-pro');
    }
