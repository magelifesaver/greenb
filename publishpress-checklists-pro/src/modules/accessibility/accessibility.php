...
use PublishPress\ChecklistsPro\Accessibility\Requirement\TableHeader;
use PublishPress\ChecklistsPro\Accessibility\Requirement\HeadingInHierarchy;
use PublishPress\ChecklistsPro\Accessibility\Requirement\SingleH1PerPage;
...
/**
 * Class PPCH_Accessibility
 *
 * @todo Refactor this module and all the modules system to use DI.
 */
#[\AllowDynamicProperties]
class PPCH_Accessibility extends Module
{
    const SETTINGS_SLUG = 'pp-accessibility-prosettings';

    const POST_META_PREFIX = 'pp_accessibility_custom_item_';

    public $module_name = 'accessibility';
    ...
    public function __construct()
    {
        ...
        $args = [
            ...
            'short_description'    => esc_html__(
                'Define tasks that verify accessibility',
                'publishpress-checklists-pro'
            ),
    ...
    {
        $scriptHandle = 'pp-accessibility-admin';

        wp_enqueue_script(
            $scriptHandle,
            plugins_url('/src/modules/accessibility/assets/js/meta-box.js', $this->pluginFile),
    ...
    public function filterPostTypeRequirements($requirements, $postType)
    {
        ...
        $requirements[] = TableHeader::class;
        $requirements[] = HeadingInHierarchy::class;
        $requirements[] = SingleH1PerPage::class;
    ...
    public function addFieldTabs()
    {
        ...
        $fieldsTabs->addTab(
            'accessibility',
            esc_html__('Accessibility', 'publishpress-checklists-pro'),
