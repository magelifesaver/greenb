 ...
 * Purpose: Fast search results renderer using the productsearch index with a
 *          simple carousel layout. This optional feature is based on
 *          version 1.0.0 of the upstream plugin. It allows you to
 *          override the default WooCommerce search results template for
 *          products by calling AAA_OC_ProductSearch_Results_Hooks::init().
 *
 * Version: 1.0.0
 */
...
class AAA_OC_ProductSearch_Results_Hooks {
    /**
     * Wire hooks for the results intercept.
     */
    public static function init() {
        add_action( 'template_redirect', [ __CLASS__, 'maybe_intercept_search' ], 9 );
    }
    /**
    ...
    public static function maybe_intercept_search() {
        ...
        echo '<div class="eee-home-carousel" data-ehp>'; echo '<div class="carousel-header">';
        echo '<h2>' . $title . '</h2>';
        echo '</div>';
