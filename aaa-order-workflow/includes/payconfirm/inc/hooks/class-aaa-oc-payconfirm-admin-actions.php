...
class AAA_OC_PayConfirm_Admin_Actions {
	...
	public static function row_action( $actions, $post ) {
		...
		$actions['aaa_oc_pc_process_now'] = '<a href="' . esc_url( $url ) . '">' . esc_html__( 'Process Now', 'aaa-order-workflow' ) . '</a>';
