...
<div class="aaa-payment-fields"
    ...
    <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:12px;">
        ...
        <?php if ( $current_status === 'out-for-delivery' ) : ?>
            <button class="button button-modern save-payment-delivered-button" data-order-id="<?php echo esc_attr( $order_id ); ?>">
                Save + Mark Delivered
            </button>
        <?php endif; ?>

        <?php if ( $current_status === 'lkd-delivered' || $current_status === 'delivered' ) : ?>
            <button class="button button-modern save-payment-complete-button" data-order-id="<?php echo esc_attr( $order_id ); ?>">
                Save + Complete
            </button>
        <?php endif; ?>
    </div>
