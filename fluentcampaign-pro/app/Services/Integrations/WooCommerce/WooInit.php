...
class WooInit
{
    public function init()
    {
        ...
        // block based revenue related and Optin
        ...
        add_action('woocommerce_payment_complete', function ($orderId) {
            ...
            if ($order->get_meta('_wc_other/fluent-crm/_fc_woo_checkout_subscribe') == '1') {
                $this->maybeSubscriptionChecked($orderId, [
    ...
    {
        // Bail early if the function doesn't exist (older WooCommerce versions)
